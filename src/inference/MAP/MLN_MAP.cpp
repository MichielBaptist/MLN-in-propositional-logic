...
{	
	...
	//Schrijf de aangepast MLN naar test_invoer (het bestand dat CCLS_to_akmaxsat gebruikt
	freopen("mln", "r", stdin);
	freopen("test_invoer", "w", stdout);
	...
	if(ctr != 1)
	{
		...
		std::system("./CCLS_to_akmaxsat test_invoer > test_uitvoer");
	}
	else
	{
		fclose(stdout);
		freopen("test_uitvoer", "w", stdout);
		printf("v");
